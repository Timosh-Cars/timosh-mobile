...
class ModalInsideModal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    elevation: 180.0,
      ...
      child: SafeArea(
        bottom: false,
        child:Container(height:500,child:ListView(padding: EdgeInsets.only(right: 6.0, bottom:25),  shrinkWrap: true,
          ...
          physics: BouncingScrollPhysics(), children: [
              Wrap(direction: Axis.horizontal, children: [
                ...
                _myChip(
                    "isSelected", "filter=Седан", 'Седан', true),
...
/*
      ...
      Padding(
                  ...
                  _myChip("isSelected26", "filter=Електро", 'Електро',
                       true),  _myChip("isSelected27", "filter=Газ", 'Газ',
                       true),  
